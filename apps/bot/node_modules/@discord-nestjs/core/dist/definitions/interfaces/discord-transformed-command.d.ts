...
export interface DiscordTransformedCommand<DTOType> {
    handler(dto: DTOType, executionContext: TransformedCommandExecutionContext): Promise<string | MessagePayload | InteractionReplyOptions | void> | string | MessagePayload | InteractionReplyOptions | void;
}
