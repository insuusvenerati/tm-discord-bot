...
let MiddlewareExplorer = class MiddlewareExplorer {
    constructor(metadataProvider) {
        ...
        Object.defineProperty(this, "middlewareList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    applyMiddleware(event, eventArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(filteredMiddleware.map((item) => item.instance.use(event, eventArgs)));
        });
    }
...
MiddlewareExplorer = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [reflect_metadata_provider_1.ReflectMetadataProvider])
], MiddlewareExplorer);
exports.MiddlewareExplorer = MiddlewareExplorer;
//# sourceMappingURL=middleware.explorer.js.map